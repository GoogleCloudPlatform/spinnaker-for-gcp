...
scripts/manage/check_git_config.sh || exit 1
...
source scripts/manage/restore_config_utils.sh
...
remove_and_copy properties scripts/install/properties
remove_and_copy config.json scripts/install/spinnakerAuditLog/config.json
remove_and_copy index.js scripts/install/spinnakerAuditLog/index.js

remove_and_copy configure_iap_expanded.md scripts/expose/configure_iap_expanded.md
remove_and_copy openapi_expanded.yml scripts/expose/openapi_expanded.yml
mkdir -p ~/.spin
